...
session_start(); //Abre a sessão criada anteriormente
exitWhenNotLoggedIn(); //Chama a função para verificar se o user está logado
$pdo = mysqlConnect(); //Conecta no banco
